...
javax.crypto.spec.IvParameterSpec ivSpec3 = new javax.crypto.spec.IvParameterSpec(cipherVAL);
String cipherVAL1="";
for(int i = 65; i < 75; i++){
    cipherVAL1 += (char) i;
}
javax.crypto.spec.IvParameterSpec ivSpec4 = new javax.crypto.spec.IvParameterSpec(cipherVAL.getBytes(),0,8);
        Cipher cipher;
        try {
